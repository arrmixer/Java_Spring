package com.AE.springdemo.interceptors;
...
public class ExecutionTimerInterceptor implements HandlerInterceptor {
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
		...
		long TOTAL_EXCUTION_TIME = AFTER_COMPLETION_TIME - PREHANDLE_TIME;
		LOGGER.info("Info Message: HANDLER_EXECUTION_TIME = "+ HANDLER_EXECUTION_TIME);
		LOGGER.info("Info Message: TOTAL_EXCUTION_TIME = "+ TOTAL_EXCUTION_TIME);
	}
