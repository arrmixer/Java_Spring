package com.AE.springdemo.controller.test;
...
public class RequestMappingAndParamDemoController {
	...
	// @RequestMapping(value="/*", method = {RequestMethod.GET,
	// RequestMethod.POST}) if want multiple
	public String requestMappingAndParamTest3() {
		return "fallback";
	}

	// test 4: Testing @RequestParam 'defaultValue' feature
	@RequestMapping(value = "/test4")
	public String requestMappingAndParamTest4(
			@RequestParam(value = "orgName", defaultValue = "Anonymous Organizatin") String orgName, Model model) {
		model.addAttribute("orgName", orgName);
	...
	// test 6, subtest 3: Testing removal of @RequestMapping with mulitiple
	// request params
	...
	// test 6, subtest 4: Testing with multiple test params @RequestParam with
	// single param
	@RequestMapping(value = "/test6/subtest4", method = RequestMethod.GET, params = { "orgName", "empCount" }) // needed
																												// in
																												// requet
																												// Http
