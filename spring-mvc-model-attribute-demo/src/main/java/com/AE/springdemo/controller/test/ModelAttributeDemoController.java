...
import com.AE.springdemo.domain.Address;
...
public class ModelAttributeDemoController {
	...
	public void modelAttributeTest1(Model model) {
		...
		model.addAttribute("testData1B",
				"We will test both usages of the @ModelAttribute, on methods and on method arguements");
	}
	...
	// Test 3: Demonstrating the usage of the @ModelAtribute annotation (on a
	...
	public String modeAttributeTest5(@ModelAttribute(value="anAddress") Address anAddress, ModelMap model) {
	...
	public Address modelAttributeTest6() {
		return new Address("Kendall", "33186");
	}
}
